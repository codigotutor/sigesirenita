...
namespace GestionAmbientesLaSirenita.Controllers
{
    public class AmbientesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,Descripcion,Ubicacion")] Ambiente ambiente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,Descripcion,Ubicacion")] Ambiente ambiente)
        {
            if (ModelState.IsValid)
            {
